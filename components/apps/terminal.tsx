    ...
    switch (mainCommand) {
      ...
      case "about":
        setHistory((prev) => [
          ...
          "web and mobile applications. I love working with modern",
          "frameworks and technologies to build",
          "seamless user experiences across platforms. I have a strong",
          "background in both frontend, backend, and mobile",
